    ...
    $.getJSON('posts/posts.list.json', function(data){
        ...
        $.each(mkFiles, function(index, file){
          $.get(file, function(text){
              ...
              const image = meta.image || '/res/images/posts/default.png';
              ...
              <div class="${newPost ? 'col-12' : 'col-6' }">
                        <div class="bg-white m-3 p-5 shadow-sm  myposts">
                            <a href="${postLink}"><div class="img-box"> 
                                <img src="${image}" class="img-fluid img-thumbnail"></a>
